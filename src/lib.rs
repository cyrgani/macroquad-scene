...
use macroquad::{
    camera::{pop_camera_state, push_camera_state, Camera2D},
    experimental::coroutines::stop_all_coroutines,
    math::{vec2, Vec2},
    prelude::scene::{register_handler, SceneHandler},
    time,
};

pub use macroquad_scene_macro::CapabilityTrait;
